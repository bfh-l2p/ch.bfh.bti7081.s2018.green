...
public class PatientManagerTest {
	...
	public void findAll() throws Exception {
		...
		insertedPatients.forEach(p1 -> {
			Assert.assertTrue(patientList.stream().anyMatch(p2 -> p1.getId() == p2.getId()));
		});
	}
	...
	public void add() throws Exception {
		...
		Assert.assertEquals(patient.getFirstName(), patientManager.get(patient.getId()).getFirstName());
	}
