...
public class StaffManagerTest {
	...
	public void staffManagerTest() throws ClassNotFoundException, ParseException {
		...
		Assert.assertArrayEquals(arrayofallpsychiatristsids, arrayofallretrievedpsychiatristsids);
		...
		Assert.assertArrayEquals(arrayofallpsychologistsids, arrayofallretrievedpsychologistsids);
